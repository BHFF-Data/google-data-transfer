...
class MentoringReportsTransferConfig(TransferConfig):
    def __init__(
        self,
        columns_join_map: Optional[dict[str, str]] = None,
        target_col: str = TARGET_COL,
        name: str = DEFAULT_NAME,
    ):
        if columns_join_map is None:
            columns_join_map = COLUMNS_JOIN_MAP
        super().__init__(columns_join_map, target_col, name)
