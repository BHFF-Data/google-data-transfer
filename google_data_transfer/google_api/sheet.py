...
class GoogleSheet:
    ...
    @classmethod
    def from_creds_dict(
            cls, credentials: dict, spreadsheet_url: str
    ):
        ...
        """
        gspread_client, authorized_user = gspread.oauth_from_dict(credentials)
        return cls(gspread_client, spreadsheet_url)

    @classmethod
    def from_access_token_dict(
            cls, access_token: dict, spreadsheet_url: str
    ):
        # TODO: re-use auth token from auth.py
        """Create a new Spreadsheet from a credentials file.
        ...
        !!! note
            ...
            The above docstring is autogenerated by docstring-gen library (https://docstring-gen.airt.ai)
        """
        gspread_client, authorized_user = gspread.oauth_from_dict(authorized_user_info=access_token)
        return cls(gspread_client, spreadsheet_url)

    @classmethod
    def from_service_account_creds(
            cls, service_account_creds: dict, spreadsheet_url: str
    ):
        # TODO: re-use auth token from auth.py
        """Create a new Spreadsheet from a credentials file.
        ...
        !!! note
            ...
            The above docstring is autogenerated by docstring-gen library (https://docstring-gen.airt.ai)
        """
        gspread_client = gspread.service_account_from_dict(info=service_account_creds)
        return cls(gspread_client, spreadsheet_url)
